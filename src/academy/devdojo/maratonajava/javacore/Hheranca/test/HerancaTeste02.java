...
public class HerancaTeste02 {
    ...
    // 3 - Cada atributo de suplerclasse é criado e inicializado com valores default ou o que for passado
    // 4 - Bloco de inicialização não estático da superclasse é executado na ordem em que aparece
    ...
    // 8 - Bloco de inicialização não estático da subclasse é executado na ordem em que aparece
